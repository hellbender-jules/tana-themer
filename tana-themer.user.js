  ...
  const THEMES = {
    ...
    'claude': {
      ...
      vars: {
        ...
        '--colorPopoverPanelBackground':         '#faf9f5',
        ...
        '--colorNavigationPanelBackground':      '#faf9f5',
        '--colorNavigationGridItemBackground':   '#faf9f5',
        '--colorTopBarBackground':               '#faf9f5',
        '--colorPanelToolbarBackground':         '#faf9f5',
        '--colorConfigBackground':               '#faf9f5',
        '--colorAIChatPanelBackground':          '#faf9f5',
        '--colorUICardBackground':               '#faf9f5',
        '--colorUICardBackgroundActive':         '#faf9f5',
